...
Xtruthreduced = Xtruth[0::100]
tkreduced = tk[0::100]

Xtruth = Xtruthreduced
tk = tkreduced
...
# stable = 'EKF'
# unstable = 'CKF'   
H_criteria = 5 #set upper limit of differential entropy before switching to the more intensive, yet more accurate filter
...
if run_EKF:
    ...
    ekf_results, covariance_results, residual_results, entropy_results = run_extended_kalman_filter(XREF, tk, Rk, Qd, initial_covar, 0, H_criteria, 0)
    filter_results['EKF'] = {
        'states': ekf_results,
...
if run_CKF:
    ...
    ckf_results, covariance_results, residual_results, entropy_results = run_cubature_kalman_filter(XREF, tk, Rk, Qd, initial_covar, 0, H_criteria, 0)
    filter_results['CKF'] = {
        'states': ckf_results,
        'covariances': covariance_results, 
        'residuals': residual_results,
...
if run_SRCKF:
    ...
    srckf_results, covariance_results, residual_results, entropy_results = run_square_root_CKF(XREF, tk, Rk, Qd, initial_covar, 0, H_criteria, 0)
...
if run_USKF:
    ...
    uskf_results, covariance_results, residual_results, entropy_results = run_unscented_schmidt_KF(XREF, tk, c, Pcc, Rk, Qd, initial_covar, 0, H_criteria, 0)
    filter_results['USKF'] = {
        'states': uskf_results,
        'covariances': covariance_results, 
        'residuals': residual_results,
...
if run_UKF:
    ...
    ukf_results, covariance_results, residual_results, entropy_results = run_unscented_kalman_filter(XREF, tk, Rk, Qd, initial_covar, 0, H_criteria, 0)
    filter_results['UKF'] = {
        'states': ukf_results,
        'covariances': covariance_results, 
        'residuals': residual_results,
...
#     hybrid_results, covariance_results, residual_results, entropy_results = run_hybrid(XREF, tk, stable, unstable, H_criteria, Qd, c, Pcc, Qd, initial_covar)
...
RotationalF = 0  # Plot in Earth-Moon rotational frame (0=inertial)
